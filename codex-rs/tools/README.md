...
`codex-tools` is the shared support crate for building and adapting
model-visible tool definitions outside `codex-core`.
...
- shared tool metadata and output helpers such as `ToolExecutor` and
  `ToolOutput`
